                        ...
                        <div class="drawer-spacer">
                            <div class="media align-items-center">
                                ...
                                <div class="media-body">
                                    <a href="#" data-toggle="sidebar" data-target="#user-drawer" class="h6 m-0 text-link">&nbsp; <?=strtoupper($_SESSION['CMS_admin_fname'] . ' ' .$_SESSION['CMS_admin_lname'])?></a>
                                    <a href="#" class="nav-link dropdown-toggle dropdown-clear-caret text-info">
                                        <?=strtoupper($_SESSION['CMS_admin_role'])?>
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <ul class="drawer-menu" id="dasboardMenu" data-children=".drawer-submenu">
                            ...
                            <li class="drawer-menu-item <?php echo ($p==3) ? 'active' : ''; ?>">
                                <a href="../admin/?p=3">
                                    ...
                                    <span class="drawer-menu-text"> User</span>
                                </a>
                            </li>
                    ...
                    <nav class="drawer drawer--light">
                        <div class="drawer-spacer drawer-spacer-border">
                            <div class="media align-items-center">
                                <a href="#" class="drawer-brand-circle mr-2">CF</a>
                                <div class="media-body">
                                    <a href="#" class="h5 m-0"><?=strtoupper($_SESSION['CMS_admin_fname'] . ' ' .$_SESSION['CMS_admin_lname'])?></a>
                                    <div><?=strtoupper($_SESSION['CMS_admin_role'])?></div>
                                </div>
                            </div>
                        </div>
