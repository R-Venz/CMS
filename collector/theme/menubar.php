                        ...
                        <div class="drawer-spacer">
                            <div class="media align-items-center">
                                ...
                                <div class="media-body">
                                    <a href="#" data-toggle="sidebar" data-target="#user-drawer" class="h6 m-0 text-link">&nbsp; <?=strtoupper($_SESSION['CMS_collector_fname'] . ' ' .$_SESSION['CMS_collector_lname'])?></a>
                                    <a href="#" class="nav-link dropdown-toggle dropdown-clear-caret text-info">
                                        <?=strtoupper($_SESSION['CMS_collector_role'])?>
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <nav class="drawer drawer--light">
                        <div class="drawer-spacer drawer-spacer-border">
                            <div class="media align-items-center">
                                <a href="#" class="drawer-brand-circle mr-2">CF</a>
                                <div class="media-body">
                                    <a href="#" class="h5 m-0"><?=strtoupper($_SESSION['CMS_collector_fname'] . ' ' .$_SESSION['CMS_collector_lname'])?></a>
                                    <div><?=strtoupper($_SESSION['CMS_collector_role'])?></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <ul class="drawer-menu" id="userMenu" data-children=".drawer-submenu">
                            <li class="drawer-menu-item">
                                <a href="../collector/?p=account">
                                    <i class="material-icons">lock</i>
                                    <span class="drawer-menu-text"> Account</span>
                                </a>
                            </li>
                            <li class="drawer-menu-item">
                                <a href="../collector/?p=logout">
