                ...
                <div class="col-lg-6">
                    <div class="media media-user-info align-items-center">
                        ...
                        <div class="media-body lh-1">
                            <p class="h4 m-0"><?=strtoupper($_SESSION['CMS_treasurer_fname'] . ' ' .$_SESSION['CMS_treasurer_lname'])?> <small style="color:<?=($_SESSION['CMS_treasurer_status']=='Active') ? 'green':'red' ?>"><?=$_SESSION['CMS_treasurer_status']?></small></p>
                            <p class="text-muted mb-0"><?=strtoupper($_SESSION['CMS_treasurer_role'])?></p>
                            ...
                            <div class="card-body">
                                <div class="form-row">
                                    <div class="form-group col-lg-6">
                                        ...
                                        <div class="input-group input-group--inline">
                                            ...
                                            <input type="text" class="form-control" readonly value="<?=$_SESSION['CMS_treasurer_fname']?>">
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        ...
                                        <div class="input-group input-group--inline">
                                            ...
                                            <input type="text" class="form-control" readonly value="<?=$_SESSION['CMS_treasurer_lname']?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group--inline">
                                        ...
                                        <input type="text" class="form-control" readonly id="u" value="<?=$_SESSION['CMS_treasurer_uname']?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group--inline">
                                        ...
                                        <input type="text" class="form-control" readonly value="<?=$_SESSION['CMS_treasurer_role']?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <li class="list-group-item list-group-item-action d-flex justify-content-between">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group--inline">
                                                ...
                                                <input type="text" class="form-control" id="uname" name="uname" value="<?=$_SESSION['CMS_treasurer_uname']?>" placeholder="Enter username" required>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="list-group-item list-group-item-action d-flex justify-content-between">
...
<script type="text/javascript">
    $('#user_form').on('submit', function(e){
        ...
        postData.append('id', decodestr('<?=$_SESSION['CMS_treasurer_id']?>'));
        $.ajax({  
