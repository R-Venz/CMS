<!-- content -->                    <!-- main content -->
                ...
                <div class="col-lg-6">
                    <div class="media media-user-info align-items-center">
                        ...
                        <div class="media-body lh-1">
                            <p class="h4 m-0"><?=strtoupper($_SESSION['CMS_member_fname'] . ' ' .$_SESSION['CMS_member_lname'])?> <small style="color:<?=($_SESSION['CMS_member_status']=='Active') ? 'green':'red' ?>"><?=$_SESSION['CMS_member_status']?></small></p>
                            <p class="text-muted mb-0"><?=strtoupper(' Family Head')?></p>
    ...
    <div class="container-fluid">
        <ul class="nav nav-pills mb-2" id="accountTabs" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" id="account-tab" data-toggle="tab" href="#account" role="tab" aria-controls="overview">My Account</a>
            </li>
            <!-- <li class="nav-item">
                            ...
                            <div class="card-body">
                                <div class="form-row">
                                    <div class="form-group col-lg-6">
                                        ...
                                        <div class="input-group input-group--inline">
                                            ...
                                            <input type="text" class="form-control" readonly value="<?=$_SESSION['CMS_member_fname']?>">
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        ...
                                        <div class="input-group input-group--inline">
                                            ...
                                            <input type="text" class="form-control" readonly value="<?=$_SESSION['CMS_member_lname']?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group--inline">
                                        ...
                                        <input type="text" class="form-control" readonly id="u" value="<?=$_SESSION['CMS_member_uname']?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group--inline">
                                        ...
                                        <input type="text" class="form-control" readonly value="Family Head">
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <li class="list-group-item list-group-item-action d-flex justify-content-between">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group--inline">
                                                ...
                                                <input type="email" class="form-control" id="uname" name="uname" value="<?=$_SESSION['CMS_member_uname']?>" placeholder="Enter username" required>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="list-group-item list-group-item-action d-flex justify-content-between">
...
<script type="text/javascript">
    $('#user_form').on('submit', function(e){
        ...
        postData.append('id', decodestr('<?=$_SESSION['CMS_member_id']?>'));
        $.ajax({  
            url:"<?=web_root?>php/membership/updateaccount2.php",  
            method:"POST",  
            data:postData,  
            contentType:false,  
            //cache:false,  
