                ...
                <div class="mdk-drawer__inner" data-simplebar data-simplebar-force-enabled="true">
                    <nav class="drawer  drawer--custom"><!-- ilisdan lang ang drawer--custom to drawer--dark para erase sa custom color -->
                        <div class="drawer-spacer">
                            <div class="media align-items-center">
                                ...
                                <div class="media-body">
                                    <a href="#" data-toggle="sidebar" data-target="#user-drawer" class="h6 m-0 text-link">&nbsp; <?=strtoupper($_SESSION['CMS_member_fname'] . ' ' .$_SESSION['CMS_member_lname'])?></a>
                        ...
                        <ul class="drawer-menu" id="dasboardMenu" data-children=".drawer-submenu">
                            ...
                            <!-- <li class="drawer-menu-item <?php echo ($p==5) ? 'active' : ''; ?>">
                                <a href="../member/?p=5">
                                    <i class="material-icons">people</i>
                                    <span class="drawer-menu-text"> Membership Record</span>
                                </a>
                            </li> -->
                    ...
                    <nav class="drawer drawer--light">
                        <div class="drawer-spacer drawer-spacer-border">
                            <div class="media align-items-center">
                                <a href="#" class="drawer-brand-circle mr-2">CF</a>
                                <div class="media-body">
                                    <a href="#" class="h5 m-0"><?=strtoupper($_SESSION['CMS_member_fname'] . ' ' .$_SESSION['CMS_member_lname'])?></a>
                                    <div>Member</div>
                                </div>
                            </div>
                        </div>
                        <div class="drawer-spacer bg-body-bg">
                            ...
                            <div class="d-flex justify-content-between">
                                <p class="h6 text-gray m-0"><i class="material-icons align-middle md-18 text-primary">supervisor_account</i> Family Member</p>
                        ...
                        <ul class="drawer-menu" id="userMenu" data-children=".drawer-submenu">
                            <li class="drawer-menu-item">
                                <a href="../member/?p=account">
                                    <i class="material-icons">lock</i>
                                    <span class="drawer-menu-text"> Account</span>
                                </a>
                            </li>
                            <li class="drawer-menu-item">
                                <a href="../member/?p=logout">
