...
<?php
 class MySqlConnect
 {
	 ...
	 private $pass;	 private $database;
//-------------------------------------------------------------------------------------------------------------
    function __construct($HOST,$USER,$PASS,$DATABASE){   
     	$this->host =$HOST;	     $this->user =$USER;
		$this->pass =$PASS;  	 $this->database =$DATABASE; 
	}
//-------------------------------------------------------------------------------------------------------------
    private function OpenDatabase(){  $Connection = mysqli_connect($this->host,$this->user,$this->pass,$this->database);
...
//-------------------------------------------------------------------------------------------------------------		  
	function DataHashing($Data){  
		$Temp="";
		$salted = "jungie".$Data."casuyac";//salted
		$Temp = hash("sha512",$salted);//hashed
		return $Data;
	}
		  
//-------------------------------------------------------------------------------------------------------------	  
	function GetLastIDAfterInsert($query){
		$Connection=$this->OpenDatabase();
		if ($Connection!=false){ 
			$result = mysqli_query($Connection,'SET CHARACTER SET utf8'); 
			$result=mysqli_query($Connection,$query) or die (mysqli_error($Connection));
